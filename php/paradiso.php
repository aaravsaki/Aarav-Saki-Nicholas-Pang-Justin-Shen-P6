...
<html lang="en">
  ...
  ::-webkit-scrollbar-track {
    box-shadow: inset 0 0 5px #070921   ;
    border-radius: 10px;
  }
...
<ul class="toc_list" style="border:3px; border-style:solid; border-color:#FFD700; padding: 1em;">
  ...
  <li><a href="#four">The Sun</a></li>
  <li><a href="#five">Mars</a></li>
  <li><a href="#six">Jupiter</a></li>
  <li><a href="#seven">Saturn</a></li>
  <li><a href="#eight">The Fixed Stars</a></li>
  <li><a href="#nine">The Primum Mobile</a></li>
  <li><a href="#ten">The Empyrean</a></li>
</ul>
</div>
    ...
    <div >
      ...
      <hr class="line1" size="5%">
        ...
        <img src="../Merch Images/The SUn.jpg"
          class="image2">
      <p class="one">
      The fourth sphere is the sun which does not make a lot of sense but just roll with it. The sun is home to the wise and holds twelve souls of people who helped intellectually illuminate the world. 
      ...
      <img src="../Merch Images/god2.jpg"
          class="image2">
      <p class="one"> 
      This is the holiest of all places and a realm of pure holy light. Here souls can see the face of god and are the closest to god anyone could possibly get.
</p>

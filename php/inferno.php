...
<html lang="en">
  ...
  <style>
    ...
    ::-webkit-scrollbar-track {
      box-shadow: inset 0 0 5px #210404 ;
      border-radius: 10px;
    }
...
<ul class="toc_list"style="border:3px; border-style:solid; border-color:#FFD700; padding: 1em;">
  ...
  <li><a href="#four">Greed</a></li>
  <li><a href="#five">Anger</a></li>
  <li><a href="#six">Heresy</a></li>
  <li><a href="#seven">Violence</a></li>
  <li><a href="#eight">Fraud</a></li>
  <li><a href="#nine">Treachery</a></li>
</ul>
</div>
    ...
    <div>
      ...
      <p class="two"; >
        ...
        <h2 id="two"> Lust </h2>
        <img src="../Merch Images/lust.jpg" class="image1" >
      ...
      <p class="two">
        ...
        <h2 id="four"> Greed </h2>
        <img src="../Merch Images/greed.jpg" class="image1" >
      ...
      class="image1">
        <p class="two">
          ...
          <p>
      <h2 id="six"> Heresy </h2>
      <img src="../Merch Images/Heresy.jpg" class="image1" >
